  ...
  return (
    <div className="flex h-screen bg-slate-100">
      <aside className="flex w-64 flex-col bg-white shadow-sm">
        ...
        <div className="px-6 py-2 text-xs font-semibold uppercase tracking-wider text-slate-400">
          Main Menu
        </div>
        ...
        <div className="mt-auto border-t border-slate-100 px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <button className="text-slate-400 hover:text-slate-700" onClick={handleLogout} title="Logout">
