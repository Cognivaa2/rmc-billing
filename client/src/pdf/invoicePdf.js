                    ...
                    columns: [
                      ...
                      },
                      {
                        ...
                        stack: [
                          ...
                          { text: client?.clientName || '', fontSize: 10, margin: [5, 0, 0, 0] },
                          { text: `Site: ${dispatch?.site?.siteName || invoice?.dispatch?.site?.siteName || invoice?.order?.site?.siteName || ''}`, fontSize: 9, margin: [5, 0, 0, 0] },
                          { text: `Site Address: ${dispatch?.site?.siteAddress || invoice?.dispatch?.site?.siteAddress || invoice?.order?.site?.siteAddress || dispatch?.site?.address || invoice?.dispatch?.site?.address || invoice?.order?.site?.address || ''}`, fontSize: 9, margin: [5, 0, 5, 5] }
                        ]
                      }
                    ]
                  },
